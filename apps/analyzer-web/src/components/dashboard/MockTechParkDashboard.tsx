  ...
  const apiCity_LocationRows = useMemo(() => {
    ...
    return currentCityWiseData.items.map((item) => {
      ...
      return ({
        ...
        total_ratings: typeof rawItem.total_ratings === "number" ? rawItem.total_ratings : 0,
        company_count: typeof rawItem.company_count === "number" ? rawItem.company_count : undefined,
